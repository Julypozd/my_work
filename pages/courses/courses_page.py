...
class CoursesPage(BaseMethods):
    ...
    _course_name = "//img[@class='course-box-image']"
    ...
    _visa = "//div[@id='option-container']//a[1]"
    _pay_pal = "//div[@id='option-container']//a[2]"
    #iframes
    ...
    def select_visa_method(self):
        ...
        self.click_element(locator=self._visa, locator_type="xpath")

    def select_paypal_method(self):
        self.click_element(locator=self._payment_method, locator_type="xpath")
        self.get_element(locator=self._all_pay_methods, locator_type="id")
        self.click_element(locator=self._pay_pal, locator_type="xpath")
    ...
    def click_all_courses(self):
        self.go_back_page()
        self.click_element(self._all_course_link, locator_type="link")
